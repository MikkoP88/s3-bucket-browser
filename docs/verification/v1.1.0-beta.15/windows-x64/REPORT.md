...
**RELEASE GATE: PASS — 63 PASS · 1 SKIP · 0 FAIL** — full matrix in 505s.
...
**Verified commit:** `cdc9fc5` — Rename certification -> verification across the release gate
**OS:** Windows_NT 10.0.26100 (x64)
**Node:** v24.12.0
**Run:** id `vermu9ufiv2`, bucket `verify-mu9ufiv2`, started 2026-09-20T13:28:13.575Z
...
| CLI-X-02 | CLI | Multi-file copy local→FTP | FTP | cp -r fixture tree (10 files: unicode, empty file, nested dirs) → xf://vermu9ufiv2/tree | PASS |
...
- CLI-S3-02 PASS — verify-mu9ufiv2 created, versioning on
